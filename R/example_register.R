...
#
# It contains two entries: one "sound" + "documented" (a real climate layer produced by a
...
example_register <- function() {
  list(
    list(id = "climate_temperature_layer",
         ...
         evidence_class = "sound",
         method_class = "documented",
         citation = "Data: ERA5-Land (Copernicus Climate Data Store), CC-BY; Munoz-Sabater et al., Earth Syst Sci Data 13:4349-4383 (2021), doi:10.5194/essd-13-4349-2021. Boundaries: World Bank 'Rwanda Admin Boundaries and Villages', CC BY 4.0. Palette: viridis; colourblind-safe per Wong 2011, Nat Methods 8:441."),
