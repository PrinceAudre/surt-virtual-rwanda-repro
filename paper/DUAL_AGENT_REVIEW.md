...
- **1 August 2026:** The first canonical R render exposed a PostScript-only font compatibility defect after all 41 account-free outcomes had passed. A guarded one-line edit removed the unsupported `family = "mono"` override while preserving every Figure 3 coordinate and label. The generator changed from Git blob `d08c03638bafc0cc6d4e4f8a864a428ff7498f9b` to `427a5f0c4fe37d9e396b4ecb8b0b074eb5270779`; the post-cleanup commit is `4252cf04cdef8f86618487c187bd6696d469875b`.
- **1 August 2026:** Visual inspection of the first successful canonical bundle found that Supplementary Figure S1's zero reference line extended through the y-axis labels because `xpd = NA` was enabled before plotting. The corrected generator clips the data and zero line with `xpd = FALSE`, then enables `xpd = NA` only for the external legend. The generator changed to Git blob `f478b7fc572c2999c9330b153342b673dbdc4475` in post-cleanup commit `f197ec21b9f63a39be6fecef76c35d25596c3855`.
