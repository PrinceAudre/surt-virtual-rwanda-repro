...
Version 1.2.0 is the DOI-bearing release based on published version 1.1.1. Its immutable Zenodo version DOI is `10.5281/zenodo.21744708`, and its Git release identifier is `v1.2.0`. Historical F1000Research submission artifacts were removed from the active tree without rewriting Git history. Journal submission remains a separate author-controlled action.
...
| Release metadata may be separated from the wrong source tree | `CITATION.cff`, README, manuscript, tag `v1.2.0`, DOI `10.5281/zenodo.21744708`, and the complete manifest must identify the same release |
